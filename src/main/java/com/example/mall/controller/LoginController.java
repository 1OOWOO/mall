...
public class LoginController {
	...
	public String login(@RequestParam("customerMail") String customerMail,
			@RequestParam("customerPw") String customerPw, Model model, HttpSession session) {
	...
	public String staffLogin(@RequestParam("staffId") String staffId, @RequestParam("staffPw") String staffPw,
