...
public class GoodsController {
	...
	public String goodsList(Model model, @RequestParam(defaultValue = "1") Integer currentPage,
	...
	public String modifyGoods(@RequestParam Integer goodsNo, @RequestParam String goodsTitle,
			@RequestParam Integer goodsPrice, @RequestParam String goodsMemo, @RequestParam String goodsState,
