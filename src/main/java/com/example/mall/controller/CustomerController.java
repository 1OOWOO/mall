...
public class CustomerController {
	...
	public String customerList(HttpSession session, Model model, @RequestParam(defaultValue = "1") Integer currentPage,
		...
		// 고객 리스트 출력
		List<Map<String, Object>> customerList = customerService.getCustomerList(currentPage, rowPerPage,
				page.countBeginRow());
	...
	public ResponseEntity<Map<String, Object>> searchCustomerList(
			@RequestParam(value = "searchEmail", required = false) String customerMail) {
	...
	// 현재 페이지 초기화
	public String deleteCustomer(String customerMail,
