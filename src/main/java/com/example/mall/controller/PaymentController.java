...
public class PaymentController {
	...
	public String addPayment(@RequestParam Integer addressNo, @RequestParam Integer paymentPrice, Payment payment,
			@RequestParam(value = "cartNo", required = false) List<Integer> cartNo) {
