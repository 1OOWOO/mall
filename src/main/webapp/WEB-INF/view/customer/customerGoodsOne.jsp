					...
					<div id="content" role="main">
						...
						<div itemscope itemtype="http://schema.org/Product" class="product">
							...
							<div class="summary entry-summary">
								...
								<form class="formCart" method="post" action="${pageContext.request.contextPath}/customer/addCart" enctype='multipart/form-data'>
									<div class="quantity">
										<input type="number" step="1" min="1" max="" name="cartAmount" value="1" title="Qty" class="input-text qty text" size="4"/>
									</div>					
									<input type="hidden" name="customerMail" value="${loggedInCustomer.customerMail}">
